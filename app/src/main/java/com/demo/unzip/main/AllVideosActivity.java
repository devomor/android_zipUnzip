...
public class AllVideosActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    File temp;
    Toolbar toolbar;
    public static final String[] All_Doc_ARRAY = {"mp4", "avi", "mpg", "mov", "wmv"};
    ...
    public void onCreate(Bundle bundle) {
        ...
        this.selectAllCheckBox.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (AllVideosActivity.this.selectAllCheckBox.isChecked()) {
                    AllVideosActivity.this.selectAllFiles();
                    AllVideosActivity.this.mFileItemAdapter.notifyDataSetChanged();
                    AllVideosActivity.fabmenu.setVisibility(View.VISIBLE);
                    return;
                }
                AllVideosActivity.this.UnSelectAllFiles();
                AllVideosActivity.this.mFileItemAdapter.notifyDataSetChanged();
                AllVideosActivity.fabmenu.setVisibility(View.GONE);
            }
        });
        ...
        floatingActionButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (AllVideosActivity.selectedItems.size() > 0) {
                    AllVideosActivity.this.openSaveDialog();
                } else {
                    Toast.makeText(AllVideosActivity.this, "No File Selected", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        floatingActionButton2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (AllVideosActivity.selectedItems.size() > 0) {
                    AlertDialog.Builder builder = new AlertDialog.Builder(AllVideosActivity.this);
                    builder.setMessage(AllVideosActivity.this.getString(R.string.deletesure));
                    builder.setCancelable(true);
                    builder.setPositiveButton(AllVideosActivity.this.getString(R.string.delete), new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialogInterface, int i) {
                            Iterator<Data_Model> it = AllVideosActivity.selectedItems.iterator();
                            while (it.hasNext()) {
                                AllVideosActivity.this.onRemoveFile(it.next());
                                AllVideosActivity.this.dismissProgressDialog1();
                            }
                            AllVideosActivity.fabmenu.setVisibility(View.GONE);
                            AllVideosActivity.fabmenu.close(true);
                            new FilesTask().execute(new String[0]);
                            AllVideosActivity.selectedItems.clear();
                        }
                    });
                    builder.setNegativeButton(AllVideosActivity.this.getString(R.string.no), new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialogInterface, int i) {
        ...
        this.searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String str2) {
                if (AllVideosActivity.this.mFileItemAdapter == null) {
                    return false;
                }
                AllVideosActivity.this.mFileItemAdapter.getFilter().filter(str2);
                return false;
            }
    ...
    public void openSaveDialog() {
        ...
        inflate.findViewById(R.id.linCompressFiles7Zip).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                create.dismiss();
                final Dialog dialog = new Dialog(AllVideosActivity.this);
                ...
                AllVideosActivity.this.fileNameToSave = editText.getText().toString();
                ...
                dialog.findViewById(R.id.linOK).setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view2) {
                        AllVideosActivity.this.fileNameToSave = editText.getText().toString();
                        if (AllVideosActivity.this.fileNameToSave.length() > 1) {
                            dialog.dismiss();
                            AllVideosActivity.this.OnCompressClick();
                            return;
                        }
                        Toast.makeText(AllVideosActivity.this, "Please Enter a name", Toast.LENGTH_SHORT).show();
                    }
                });
                dialog.show();
            }
        ...
        inflate.findViewById(R.id.linCompressFilesZip).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (AllVideosActivity.selectedItems.size() > 0) {
                    create.dismiss();
                    final AlertDialog create2 = new AlertDialog.Builder(AllVideosActivity.this).create();
                    View inflate2 = AllVideosActivity.this.getLayoutInflater().inflate(R.layout.dialog_already, (ViewGroup) null);
                    create2.getWindow().setBackgroundDrawable(new ColorDrawable(0));
                    final EditText editText = (EditText) inflate2.findViewById(R.id.edtFileName);
                    editText.requestFocus();
                    ((InputMethodManager) AllVideosActivity.this.getSystemService(Context.INPUT_METHOD_SERVICE)).toggleSoftInput(2, 0);
                    inflate2.findViewById(R.id.linOK).setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View view2) {
                            AllVideosActivity.this.fileName = editText.getText().toString();
                            if (AllVideosActivity.this.fileName.isEmpty()) {
                                return;
                            }
                            create2.dismiss();
                            new Intent(AllVideosActivity.this, ZipFileService.class);
                            ArrayList arrayList = new ArrayList();
                            for (int i = 0; i < AllVideosActivity.selectedItems.size(); i++) {
                                arrayList.add(AllVideosActivity.selectedItems.get(i).getFilePath());
                            }
                            new Zip_Compression_bgTask().execute(Integer.valueOf(AllVideosActivity.selectedItems.size()));
                        }
                    });
            ...
            if (id == R.id.linMenu) {
                ...
                dialog.findViewById(R.id.linOpenFile).setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view2) {
                        ...
                        try {
                            Open_File_By_File_Format.openFile(AllVideosActivity.this, new File(data_Model.getFilePath()));
                ...
                dialog.findViewById(R.id.linCompressFiles).setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view2) {
                        AllVideosActivity.this.onCompressFile(data_Model);
                        dialog.cancel();
                    }
                });
                dialog.findViewById(R.id.linShareFiles).setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view2) {
                        ...
                        try {
                            AllVideosActivity.this.startActivity(Intent.createChooser(intent, "Share ZIP File"));
                        } catch (Exception unused) {
                        }
                        dialog.cancel();
                    }
                ...
                dialog.findViewById(R.id.linDeleteFiles).setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view2) {
                        ...
                        builder.setPositiveButton(AllVideosActivity.this.getString(R.string.delete), new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialogInterface, int i) {
                                AllVideosActivity.this.onRemoveFile(data_Model);
                                new FilesTask().execute(new String[0]);
                                dialogInterface.dismiss();
                            }
                        });
    ...
    public void onRemoveFile(final Data_Model data_Model) {
        ...
        Observable.create(new ObservableOnSubscribe<String>() {
            ...
            public void subscribe(ObservableEmitter<String> observableEmitter) throws Exception {
                String message;
                try {
                    AllVideosActivity.this.removeFile(new File(data_Model.getFilePath()));
    ...
    private void runCommand(final String str) {
        Observable.create(new ObservableOnSubscribe<Integer>() {
            ...
            public void accept(Integer num) throws Exception {
                ...
                AllVideosActivity.this.showResult(num.intValue());
            }
        });
    }
        ...
        if (i == 255) {
            ...
            inflate.findViewById(R.id.linOpenFolder).setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    allVideosActivity.startActivity(new Intent(allVideosActivity, CompressFilesActivity.class));
    ...
    private class FilesTask extends AsyncTask<String, Void, String> {
        ...
        private void showProgressDialog() {
            if (this.dialog == null) {
                ProgressDialog progressDialog = new ProgressDialog(AllVideosActivity.this);
                this.dialog = progressDialog;
                progressDialog.setTitle(AllVideosActivity.this.getString(R.string.pelasewait));
                progressDialog.setMessage(AllVideosActivity.this.getString(R.string.take_som));
        ...
        public String doInBackground(String... strArr) {
            AllVideosActivity allVideosActivity = AllVideosActivity.this;
            allVideosActivity.files = allVideosActivity.getListFiles(allVideosActivity.root);
            if (AllVideosActivity.this.FilesExternal == null) {
                return null;
            }
            AllVideosActivity allVideosActivity2 = AllVideosActivity.this;
            allVideosActivity2.filXESsd = allVideosActivity2.getListFiles(allVideosActivity2.FilesExternal);
            AllVideosActivity.this.files.addAll(AllVideosActivity.this.filXESsd);
            return null;
        }
        ...
        public void onPostExecute(String str) {
            ...
            AllVideosActivity allVideosActivity = AllVideosActivity.this;
            All_files_adapter all_files_adapter = new All_files_adapter(allVideosActivity, allVideosActivity);
            allVideosActivity.mFileItemAdapter = all_files_adapter;
            AllVideosActivity.this.mStorageListView.setAdapter(all_files_adapter);
            AllVideosActivity.this.mFileItemAdapter.setDataList(AllVideosActivity.this.files);
            AllVideosActivity.this.mFileItemAdapter.notifyDataSetChanged();
            View findViewById = AllVideosActivity.this.findViewById(R.id.noitem);
    ...
    public class Zip_Compression_bgTask extends AsyncTask<Integer, Integer, String> {
        ...
        public void onPostExecute(String str) {
            ...
            builder.setMessage(AllVideosActivity.this.getString(R.string.zipping_3) + this.name);
            ...
            builder.setNegativeButton(R.string.open_folder, new DialogInterface.OnClickListener() {
                @Override
                public void onClick(DialogInterface dialogInterface, int i) {
                    AllVideosActivity.this.startActivity(new Intent(AllVideosActivity.this, CompressFilesActivity.class));
                    AllVideosActivity.this.finish();
                }
            });
            builder.create().show();
        ...
        private void showProgressDialog() {
            if (this.dialog == null) {
                ProgressDialog progressDialog = new ProgressDialog(AllVideosActivity.this);
                this.dialog = progressDialog;
                progressDialog.setMessage(AllVideosActivity.this.getString(R.string.zip34));
                progressDialog.setIndeterminate(true);
                progressDialog.setMax(AllVideosActivity.selectedItems.size());
    ...
    public static class All_files_adapter extends RecyclerView.Adapter<All_files_adapter.ViewHolder> implements Filterable {
        ...
        public void onBindViewHolder(final ViewHolder viewHolder, final int i) {
            if (this.mFileInfoListfilter.size() >= i) {
                ...
                if (data_Model.getFileName().endsWith("mp4")) {
                    Glide.with(this.mActivity).load(data_Model.getFilePath()).into(viewHolder.icon);
                } else if (data_Model.getFileName().endsWith("avi")) {
                    Glide.with(this.mActivity).load(data_Model.getFilePath()).into(viewHolder.icon);
                } else if (data_Model.getFileName().endsWith("mpg")) {
                    Glide.with(this.mActivity).load(data_Model.getFilePath()).into(viewHolder.icon);
                } else if (data_Model.getFileName().endsWith("mov")) {
                    Glide.with(this.mActivity).load(data_Model.getFilePath()).into(viewHolder.icon);
                } else if (data_Model.getFileName().endsWith("wmv")) {
                    Glide.with(this.mActivity).load(data_Model.getFilePath()).into(viewHolder.icon);
                } else {
                    viewHolder.icon.setImageResource(R.drawable.home_icon_all_video_main_page_icon);
                }
                ...
                viewHolder.box.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        AllVideosActivity.fabmenu.setVisibility(View.VISIBLE);
                        if (AllVideosActivity.checkmenu != 0) {
                            int i2 = AllVideosActivity.checkmenu;
                        }
                        if (viewHolder.box.isChecked()) {
                            All_files_adapter.this.mFileInfoListfilter.get(i).setSelected(true);
                            All_files_adapter.counter++;
                            AllVideosActivity.fabmenu.setVisibility(View.VISIBLE);
                            AllVideosActivity.selectedItems.add(data_Model);
                            return;
                        }
                        AllVideosActivity.selectedItems.remove(data_Model);
                        All_files_adapter.counter--;
                        AllVideosActivity.selectedItems.remove(data_Model);
                        All_files_adapter.counter--;
                        ...
                        if (All_files_adapter.counter == 1) {
                            ...
                            int i3 = AllVideosActivity.checkmenu;
                        }
                    }
                });
            }
        ...
        public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            View inflate = LayoutInflater.from(this.mActivity).inflate(R.layout.item_layout_all_video, viewGroup, false);
                        ...
                        all_files_adapter2.mActivity.runOnUiThread(new Runnable() {
                            ...
                            public void run() {
                                if (All_files_adapter.this.mActivity instanceof AllAudiosActivity) {
                                    if (arrayList.size() == 0) {
                                        AllVideosActivity.setTvNoSearchFoundVisibility(0);
                                    } else {
                                        AllVideosActivity.setTvNoSearchFoundVisibility(8);
                                    }
                                }
                            }
                        });

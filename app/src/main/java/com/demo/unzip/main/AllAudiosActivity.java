...
public class AllAudiosActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onCreate(Bundle bundle) {
        ...
        this.selectAllCheckBox.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (AllAudiosActivity.this.selectAllCheckBox.isChecked()) {
                    AllAudiosActivity.this.selectAllFiles();
                    AllAudiosActivity.this.mFileItemAdapter.notifyDataSetChanged();
                    AllAudiosActivity.fabmenu.setVisibility(View.VISIBLE);
                    return;
                }
                AllAudiosActivity.this.UnSelectAllFiles();
                AllAudiosActivity.this.mFileItemAdapter.notifyDataSetChanged();
                AllAudiosActivity.fabmenu.setVisibility(View.GONE);
            }
        });
        ...
        floatingActionButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (AllAudiosActivity.selectedItems.size() > 0) {
                    ...
                    Toast.makeText(AllAudiosActivity.this, "No File Selected", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        floatingActionButton2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (AllAudiosActivity.selectedItems.size() > 0) {
                    ...
                    builder.setPositiveButton(AllAudiosActivity.this.getString(R.string.delete), new DialogInterface.OnClickListener() {
                        @Override
                    ...
                    builder.setNegativeButton(AllAudiosActivity.this.getString(R.string.no), new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialogInterface, int i) {
        ...
        this.searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String str2) {
                if (AllAudiosActivity.this.mFileItemAdapter == null) {
                    return false;
                }
                AllAudiosActivity.this.mFileItemAdapter.getFilter().filter(str2);
                return false;
            }
    ...
    public void openSaveDialog() {
        ...
        inflate.findViewById(R.id.linCompressFiles7Zip).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                AllAudiosActivity.this.fileNameToSave = editText.getText().toString();
                ...
                dialog.findViewById(R.id.linOK).setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view2) {
                        AllAudiosActivity.this.fileNameToSave = editText.getText().toString();
                        if (AllAudiosActivity.this.fileNameToSave.length() > 1) {
                            dialog.dismiss();
                            AllAudiosActivity.this.OnCompressClick();
                            return;
                        }
                        Toast.makeText(AllAudiosActivity.this, "Please Enter a name", Toast.LENGTH_SHORT).show();
                    }
                });
                dialog.show();
            }
        ...
        inflate.findViewById(R.id.linCompressFilesZip).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (AllAudiosActivity.selectedItems.size() > 0) {
                    ...
                    ((InputMethodManager) AllAudiosActivity.this.getSystemService(Context.INPUT_METHOD_SERVICE)).toggleSoftInput(2, 0);
                    inflate2.findViewById(R.id.linOK).setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View view2) {
                            AllAudiosActivity.this.fileName = editText.getText().toString();
                            if (AllAudiosActivity.this.fileName.isEmpty()) {
                                return;
                            }
                            create2.dismiss();
                            new Intent(AllAudiosActivity.this, ZipFileService.class);
            ...
            if (id == R.id.linMenu) {
                ...
                dialog.findViewById(R.id.linShareFiles).setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view2) {
                        ...
                        try {
                            AllAudiosActivity.this.startActivity(Intent.createChooser(intent, "Share ZIP File"));
                        } catch (Exception unused) {
                        }
                        dialog.cancel();
                    }
        ...
        if (i == 255) {
            ...
            inflate.findViewById(R.id.linOpenFolder).setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    allAudiosActivity.startActivity(new Intent(allAudiosActivity, CompressFilesActivity.class));
    ...
    public void showProgressDialog() {
        ...
        this.progressDialog.setTitle(getString(R.string.pelasewait));
        this.progressDialog.setMessage(getString(R.string.take_som));
    ...
    private class FilesTask extends AsyncTask<String, Void, String> {
        ...
        public String doInBackground(String... strArr) {
           ...
           filXESsd =getListFiles(FilesExternal);
            files.addAll(filXESsd);
            return null;
        }
        @Override
        public void onPostExecute(String str) {
            ...
            allAudiosActivity.mFileItemAdapter = all_files_adapter;
            AllAudiosActivity.this.mStorageListView.setAdapter(all_files_adapter);
            AllAudiosActivity.this.mFileItemAdapter.setDataList(AllAudiosActivity.this.files);
            AllAudiosActivity.this.mFileItemAdapter.notifyDataSetChanged();
    ...
    public class Zip_Compression_bgTask extends AsyncTask<Integer, Integer, String> {
        ...
        public void onPostExecute(String str) {
            ...
            builder.setMessage(AllAudiosActivity.this.getString(R.string.zipping_3) + " "+fileName);
            ...
            builder.setNegativeButton(R.string.open_folder, new DialogInterface.OnClickListener() {
                @Override
                public void onClick(DialogInterface dialogInterface, int i) {
                    AllAudiosActivity.this.startActivity(new Intent(AllAudiosActivity.this, CompressFilesActivity.class));
                    AllAudiosActivity.this.finish();
                }
            });
            builder.create().show();
    ...
    public static class All_files_adapter extends RecyclerView.Adapter<All_files_adapter.ViewHolder> implements Filterable {
        ...
        public void onBindViewHolder(final ViewHolder viewHolder, @SuppressLint("RecyclerView") final int i) {
            if (this.mFileInfoListfilter.size() >= i) {
                ...
                viewHolder.icon.setImageResource(R.drawable.music_default_thumbnail_icon);
                ...
                viewHolder.box.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        if (All_files_adapter.counter == 1) {
                            ...
                            int i3 = AllAudiosActivity.checkmenu;
                        }
                    }
                });
            }
                        ...
                        all_files_adapter2.mActivity.runOnUiThread(new Runnable() {
                            ...
                            public void run() {
                                if (All_files_adapter.this.mActivity instanceof AllAudiosActivity) {
                                    if (arrayList.size() == 0) {
                                        AllAudiosActivity.setTvNoSearchFoundVisibility(0);
                                    } else {
                                        AllAudiosActivity.setTvNoSearchFoundVisibility(8);
                                    }
                                }
                            }
                        });
